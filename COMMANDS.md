...
cargo run -- --node-id 1 --address 127.0.0.1:3000 --leader-id 1 --peer-addresses 127.0.0.1:3001,127.0.0.1:3002
...
cargo run -- --node-id 2 --address 127.0.0.1:3001 --leader-id 1 --peer-addresses 127.0.0.1:3000,127.0.0.1:3002
